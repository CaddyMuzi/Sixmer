...
wb = load_workbook(filename=logfile)
...
sheet = wb.create_sheet(title=name1, index=0)
...
while play:
    ...
    if players == 1:
        UserInput = int(input("please enter your six digit unique number(No Zeroes): "))
        ...
        content2log = [name1, numberfinal, x1, x2, x3, x4, x5, x6, tries1, score1]
        sheet.append(content2log)

    if players == 2:
        if turn % 2 == 0:
            print(name1, ",please enter your six digit unique number below(Press enter after each digit)")
            x1 = int(input())
            x2 = int(input())
            x3 = int(input())
            x4 = int(input())
        ...
        if turn % 2 == 1:
            ...
            numberfinal = str(a) + str(b) + str(c) + str(d) + str(e) + str(f)
            content2log = [name1, names2, numberfinal, x1, x2, x3, x4, x5, x6, tries1, tries2, score1, score2]
            sheet.append(content2log)
